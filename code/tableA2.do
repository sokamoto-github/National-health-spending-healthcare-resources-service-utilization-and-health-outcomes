...
*---------------------------------------------------------------------------------------------------
	...
	*** The effects of health spending
	...
	cap erase $table/tableA2/tableA2.xls
	cap erase $table/tableA2/tableA2.txt	
	...
	* resources & utilization
	...
	xtreg ln`i' lnhealth l.lnhealth l2.lnhealth l3.lnhealth logy `ctl', fe
		outreg2 using "$table/tableA2/tableA2.xls", drop(`ctl') append auto(3) dec(2) nocon ci noaster addtext(Year Dummy, "Yes", Control, "Yes", Model, "FE") 					
		}