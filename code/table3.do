...
*---------------------------------------------------------------------------------------------------
	...
	*** The effects of oop and noop
	
	cap erase $table/table3/table3.xls
	cap erase $table/table3/table3.txt	
	...
	* resources & utilization
	...
	foreach i in bed doc nurses care staff measles imr mr {
		...
		outreg2 using $table/table3/table3.xls, drop(`ctl') append dec(2) nocon ci noaster addtext(Year Dummy, "Yes", Control, "Yes", Model, "FE") 
